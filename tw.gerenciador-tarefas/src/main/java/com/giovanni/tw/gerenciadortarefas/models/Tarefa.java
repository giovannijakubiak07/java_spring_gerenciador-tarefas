package com.giovanni.tw.gerenciadortarefas.models;
...
public class Tarefa {
	...
	@Column(name="tar_titulo", length = 50, nullable = true )
	@javax.validation.constraints.NotNull(message="O título é obrigatório")
